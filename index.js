...
myCompany.addEmployee(new Manager("Bob", 3200, "Marketing", 35, 1.5));
...
testframework(
    ...
    [
      ...
      3200 * 1.5, // Marketing департамент (Bob)
      3000 + (85 * 150), // Sales департамент (Diana)
      [{ name: "Bob", basicSalary: 3200, department: "Marketing", factor: 1.5 }],
      "Bob", 
      [
